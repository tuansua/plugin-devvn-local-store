...
(function($){
    $(document).ready(function(){
            ...
            if(response.success) {
                ...
                for (var i = 0; i < maps_data.length; i++)
                {
                    ...
                    if(dataMarker['phone1']) {
                        $html += 'Điện thoại: <a href="tel:'+dataMarker['phone1']+'">'+dataMarker['phone1']+'</a>';
                    }
                    ...
                    $html += '</p>';
                    $html += '<a href="https://maps.google.com?saddr=Current+Location&daddr='+lat+','+lng+'" target="_blank" rel="nofollow" class="tim-dg">'+devvn_localstore_array.labels.get_directions+'</a>';
                    $html += '</div>';
                    $html += '</div>';
        ...
        function createMarker(dataMarker){
            ...
            html += '<p>'+dataMarker.address+'</p>';
            //tel
            if(dataMarker.hotline1 || dataMarker.hotline2 || dataMarker.phone1) {
            ...
            html += '<a href="https://maps.google.com?saddr=Current+Location&daddr='+dataMarker.maps_lat+','+dataMarker.maps_lng+'" target="_blank" rel="nofollow" class="tim-dg">'+devvn_localstore_array.labels.get_directions+'</a>';
            html += '</div>';
